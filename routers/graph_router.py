...
from resolvers.mutations import add_notification, create_potlukk, swap_potlukk_dishes, merge_potlukk_details, send_invite, update_invite
...
class Mutation:
    ...
    merge_potlukk_details: Potlukk | None = strawberry.mutation(resolver=merge_potlukk_details)
